...
def user_input(user_question, db_vectors):
    ...
    # load a FAISS vector database from local file
    # new_db = FAISS.load_local("faiss_index", embeddings)

    # perform similarity search on vector db based on user question
    # docs = new_db.similarity_search(user_question)

    # similarity_search_by_vector : accepts embedding vector as a parameter
...
def main():
    ...
    markdown_path = "/Users/harshitawork/Desktop/chatbot/pdfParser/mca_curriculum.md"
